...
export { MultiDiffPreviewOverlay, type MultiDiffPreviewOverlayProps, type FileChange, type DiffViewerSettings, computeChangeStats, createFileSections, type FileSection } from './MultiDiffPreviewOverlay'
