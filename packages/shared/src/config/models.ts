...
export const MODEL_REGISTRY: ModelDefinition[] = [
  ...
  // See ModelRefreshService in packages/server-core/src/model-fetchers/
  // ----------------------------------------
];
...
/**
 * All Anthropic Claude models. The fork's single-Pi-backend registry holds
 * Claude models exclusively (provider 'pi'), so this aliases the full
 * registry rather than filtering by a non-existent 'anthropic' provider.
 */
