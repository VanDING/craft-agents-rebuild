...
describe('matcherMatchesAgentInput with conditions', () => {
  it('should pass when the agent matcher and conditions both pass', () => {
    const matcher = {
      matcher: '^Bash$',
      conditions: [
  ...
  it('should fail when the agent matcher passes but conditions fail', () => {
    const matcher = {
      matcher: '^Bash$',
      conditions: [
  ...
  it('should fail when the agent matcher does not match regardless of conditions', () => {
    const matcher = {
      matcher: '^Read$',
      conditions: [
