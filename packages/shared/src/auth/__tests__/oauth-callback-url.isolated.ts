...
// Restore the real fetch after this file's tests — the worker process is
// reused for subsequent test files, and a leaked 404-mock broke every fetch
// in them (e.g. the webui http-server suite).
afterAll(() => {
