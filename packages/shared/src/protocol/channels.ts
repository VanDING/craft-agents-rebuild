...
export const RPC_CHANNELS = {
  ...
  theme: {
    ...
    GET_PREFERENCES: 'theme:getPreferences',
    SET_PREFERENCES: 'theme:setPreferences',
    ...
    USER_THEMES_CHANGED: 'theme:userThemesChanged',
  ...
  workItems: {
    ...
    LIST_VIEWS: 'workItems:list-views',
    CREATE_VIEW: 'workItems:create-view',
    UPDATE_VIEW: 'workItems:update-view',
    DELETE_VIEW: 'workItems:delete-view',
    CHANGED: 'workItems:changed',
  },
  artifacts: {
    LIST: 'artifacts:list',
    GET: 'artifacts:get',
    REGISTER_CURRENT: 'artifacts:registerCurrent',
    CREATE: 'artifacts:create',
    APPLY: 'artifacts:apply',
    INSPECT: 'artifacts:inspect',
    SUBMIT: 'artifacts:submit',
    REVISE: 'artifacts:revise',
    ACCEPT: 'artifacts:accept',
    DISCARD: 'artifacts:discard',
    ACQUIRE_LEASE: 'artifacts:acquireLease',
    RELEASE_LEASE: 'artifacts:releaseLease',
