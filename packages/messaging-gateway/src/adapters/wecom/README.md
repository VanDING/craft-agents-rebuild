# WeCom intelligent-bot gateway

This adapter implements the conversation channel described by the WeCom
intelligent-bot long-connection documentation. It receives direct and
...
- WeCom CLI or MCP installation/lifecycle;
...
WeCom permits only one active long connection for the same Bot ID.
...
WeCom administrator console. Otherwise the official SDK default,
