  ...
  ({ children, isActive, className, disabled, ...props }, ref) => {
    return (
      <button
        ...
        disabled={disabled}
        className={cn(
          "craft-icon-button header-icon-btn h-7 w-7 flex items-center justify-center titlebar-no-drag",
          "hover:bg-foreground/5 ",
          "disabled:opacity-30 disabled:pointer-events-none",
          "motion-interactive transition-[background-color,opacity,transform] active:scale-[var(--motion-scale-pressed)]",
