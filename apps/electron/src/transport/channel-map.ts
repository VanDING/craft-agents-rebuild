...
export const CHANNEL_MAP = {
  ...
  getRecoveryEvidence: invoke(RPC_CHANNELS.sessions.GET_RECOVERY_EVIDENCE),
  reconcileTool: invoke(RPC_CHANNELS.sessions.RECONCILE_TOOL),
  queryReconcileTool: invoke(RPC_CHANNELS.sessions.QUERY_RECONCILE_TOOL),
  reconcileModel: invoke(RPC_CHANNELS.sessions.RECONCILE_MODEL),
  ...
  getThemePreferences: invoke(RPC_CHANNELS.theme.GET_PREFERENCES),
  setThemePreferences: invoke(RPC_CHANNELS.theme.SET_PREFERENCES),
  ...
  onUserThemesChanged: listener(RPC_CHANNELS.theme.USER_THEMES_CHANGED),
