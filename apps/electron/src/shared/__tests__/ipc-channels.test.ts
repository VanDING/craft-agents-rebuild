...
const EXPECTED_CHANNELS: string[] = [
  ...
  "messaging:wechat:cancelConnect",
  ...
  "sessions:getRecoveryEvidence",
  "sessions:getUnreadSummary",
  "sessions:import",
  "sessions:importRemoteTransfer",
  "sessions:killShell",
  "sessions:markAllRead",
  "sessions:queryReconcileTool",
  "sessions:reconcileModel",
  "sessions:reconcileTool",
  ...
  "terminal:data",
  "terminal:destroy",
  "terminal:destroyForWorkspace",
  "terminal:exit",
  "terminal:getForWorkspace",
  "terminal:resize",
  "terminal:write",
  "theme:appChanged",
